...
class ImageMessageBuilder extends AbstractMediaBuilder
{
    public function send(): MessageResponse
    {
        $data     = new MediaMessageData(to: $this->to, mediaType: MediaType::Image, mediaId: $this->mediaId, link: $this->link, caption: $this->caption, replyToMessageId: $this->replyTo);
