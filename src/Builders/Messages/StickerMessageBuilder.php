...
class StickerMessageBuilder extends AbstractMediaBuilder
{
    public function send(): MessageResponse
    {
        $data     = new MediaMessageData(to: $this->to, mediaType: MediaType::Sticker, mediaId: $this->mediaId, link: $this->link, replyToMessageId: $this->replyTo);
